...
const NavSearch = () => {
  ...
  const onSearchItemSelect = (item: Item) => {
    ...
    // this is triggering en eslint error : Error: Expected an assignment or function call and instead saw an expression.  @typescript-eslint/no-unused-expressions
  ...
  return (
    <>
      <div className="px-4 w-full md:flex 3xl:w-auto 3xl:shrink-0 3xl:justify-center">
        <button
          ...
          <Search className="me-3 shrink-0" />
          Search
      ...
      <div>
        ...
        <div className='flex items-center justify-between border-b-2 border-[#3a3d54] mx-8 mt-4 gap-2'>
          <Title hidden />
          <Description hidden />
          <Search size={20} />
